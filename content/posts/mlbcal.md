...
_Note: I found a bug while writing this post where three pairs of teams shared the same franchiseName value: "New York" for NYA/NYN, "Chicago" for CHA/CHN, and "Los Angeles" for LAA/LAN. I publishing a fix that removed franchiseName from the list of parsed out team names to eliminate this ambiguity._
